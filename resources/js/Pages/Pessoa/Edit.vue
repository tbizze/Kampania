...
const form = useForm({
  ...
  // Campos de endereço
  logradouro: props.registro.has_endereco.logradouro,
  numero: props.registro.has_endereco.numero,
  bairro: props.registro.has_endereco.bairro,
  complemento: props.registro.has_endereco.complemento,
  cep: props.registro.has_endereco.cep,
  cidade: props.registro.has_endereco.cidade,
  uf: props.registro.has_endereco.uf,
  notas_end: props.registro.has_endereco.notas,
});
