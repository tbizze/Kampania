      ...
      <template #formBody>
        <form @submit.prevent="submit()">
          ...
          <div class=" mt-10 mb-8 border-2 p-4">
            <div class="pb-2 font-bold textarea-md pl-0">DADOS DA CAMPANHA:</div>
            ...
            <div class="md:flex gap-2 mb-4">
              ...
              <div class="md:w-1/4">
                <BizField id="dt_adesao" label="Dt. Adesão" :error="form.errors.dt_adesao">
                  <BizInput v-model="form.dt_adesao" placeholder="Digite uma data" type="text" />
                </BizField>
              </div>
              <div class="md:w-1/4">
                <BizField id="valor" label="Valor" :error="form.errors.valor">
                  <BizInput v-model="form.valor" placeholder="Digite um valor" type="text" />
                </BizField>
              </div>
              <!-- Campo Grupo -->
              <div class="md:w-1/4">
            ...
            <div class="md:flex gap-5 mb-4">
              ...
              <div class="block ml-07">
                <label class="flex items-center">
                  <input type="checkbox" v-model="form.notif_whatsapp" :value="11"
                    class="w-5 h-5 border rounded border-gray-300  bg-gray-50 focus:ring-3 focus:ring-blue-300" />
